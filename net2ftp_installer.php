...
elseif ($_GET["security_code"] != "etvxur2rgei2tg6yp87v" || $_GET["security_code"] == ("NET2FTP_" . "SECURITY_CODE")) { 
...
$tempdir = dirname(__FILE__) . "/net2ftp_temp_vt0l";
...
?>
<form name="ActionForm" action="net2ftp_installer.php?security_code=etvxur2rgei2tg6yp87v" method="post">
...
<tr><td>Username</td><td><input type="text" name="username" size="25" value="wynsewv"></td></tr>
